        ...
        <div class="row">
                ...
                <?php if (!empty($data['carts'])) : ?>
                    <table class="table table-sm table-bordered">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <td><img src="<?php echo URLROOT; ?>/public/food_images/<?php echo htmlspecialchars($item['image']); ?>" alt="food image"></td>
                                    ...
                                    <td>
                                        <a href="<?php echo URLROOT; ?>/cartController/destroy/<?php echo htmlspecialchars($item['cart_id']); ?>" class="text-danger lead" onclick="return confirm('Are you sure want to remove this item?');"><i class="uil uil-trash-alt"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                            <tr>
            ...
            <div class="col-md-4">
                <div class="summary custom-bg">
                    ...
                    <?php endif; ?>
                    <button type="button" class="btn btn-yellow mt-3"><a href="<?php echo URLROOT;?>/cartController/payMent">CHECKOUT</a></button>
                </div>
